  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="h-screen p-4 flex flex-col">
        ...
        <div className="bg-[#B2EBF2] rounded-[32px] p-8 h-[75vh] flex flex-col">
          {/* Navigation */}
          ...
          <div className="flex justify-between items-center flex-1">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-700 mb-8 max-w-lg leading-relaxed">
                Experience the future of work with Adam AI. Intelligent email management, 
                smart scheduling, and context-aware assistance to help you achieve more.
              </p>
